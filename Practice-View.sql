...
SELECT customerNumber'Mã người dùng', customerName'Tên người dùng', phone'Số điện thoai'
...
SELECT customerNumber'Mã người dùng', customerName'Tên người dùng', contactFirstName'Tên', 
contactLastName'Họ', phone'Số điện thoại'
